...
exports.sendWelcome = function(data, fn){
  send({from:'noreply@foodtruckapp.com', to:data.to, subject:'Welcome to FoodTruck app', template:'welcome'}, fn);
};
...
function send(data, fn){
  ...
  var url = 'https://api:' + key + '@api.mailgun.net/v2/codedbytyler.net/messages';
